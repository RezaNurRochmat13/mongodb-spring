...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/2.5.11/reference/htmlsingle/#boot-features-mongodb)
* [Spring Boot Actuator](https://docs.spring.io/spring-boot/docs/2.5.11/reference/htmlsingle/#production-ready)
